    ...
    return (
        <div className="bg-transparent mt-16 ml-0 2xl:ml-64"> 
            <main className="flex flex-col flex-1 gap-4 pt-4 mx-4">
                <section className="bg-white flex flex-row items-center justify-between p-6 shadow-md rounded-lg">
                ...
                <section className="bg-transparent flex flex-col lg:flex-row justify-between gap-4">
                ...
                <section className="bg-white p-4 shadow-md flex flex-col gap-3 rounded-lg">
