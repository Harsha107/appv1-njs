...
export default function DashboardOverview() {
    ...
    return (
        <div className="bg-gray-100 mt-16 ml-64">
            <main className="bg-transparent flex flex-col justify-between max-w-6xl ml-4">
                ...
                <div className="bg-transparent w-full mt-5">
                    <div className="flex flex-row justify-between">
                        {cardData[filter as keyof typeof cardData]?.map((activity: {title: string, count: string, subtext: string, popup: string}, index: number) => (
                            <div key={index} className="bg-white shadow-md rounded-lg w-64 py-6 px-4 flex flex-row justify-between">
                ...
                <a href="/" className="mt-4 no-underline hover:underline pb-10">&lt; Back to user list?</a>
            </main>
        </div>
    )
}